...
## Cockpit Docker Manager v${TAG_VERSION} (Pre-release)
...
EOF
  ...
  draft)
    cat > release_notes.md <<EOF
## Cockpit Docker Manager v${VERSION}

Debian packaging for Cockpit Docker Manager.
...
- Cockpit plugin for Docker container management
- Web-based Docker container interface
